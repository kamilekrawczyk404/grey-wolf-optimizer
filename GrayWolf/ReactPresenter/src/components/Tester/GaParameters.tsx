...
const ParameterInput = ({ label, value, onChange }: { label: string; value: string | number; onChange: (val: any) => void; }) => (
    <div className="flex flex-col gap-1 flex-1">
        ...
        <input
            className="p-2 rounded bg-neutral-800 text-white w-full border border-neutral-700 focus:border-yellow-500 outline-none"
            value={value}
...
const GaParameters: React.FC = () => {
    ...
    return (
        <div className="space-y-4">
            <SectionContainer header="Genetic Algorithm Parameters">
                ...
                <button
                    ...
                    disabled={loading}
                    className={`mt-4 px-4 py-2 rounded ${loading ? "bg-neutral-700 cursor-not-allowed" : "bg-yellow-600 hover:bg-yellow-500 text-white"}`}
                >
                    {loading ? "Running GA..." : "Run Genetic Algorithm"}
                </button>
            </SectionContainer>
