...
const ParameterInput = ({ label, value, onChange }: { label: string; value: string | number; onChange: (val: any) => void; }) => (
    <div className="flex flex-col gap-1 flex-1">
        ...
        <input
            className="p-2 rounded bg-neutral-800 text-white w-full border border-neutral-700 focus:border-cyan-500 outline-none"
            value={value}
...
const PsoParameters: React.FC = () => {
    ...
    const runOptimizer = async () => {
        ...
        const requestBody = {
            Algorithm: "PSO", // Klucz dla backendu
    ...
    return (
        <div className="space-y-4">
            <SectionContainer header="PSO Parameters">
                ...
                >
                    {loading ? "Running PSO..." : "Run Particle Swarm"}
                </button>
            </SectionContainer>
