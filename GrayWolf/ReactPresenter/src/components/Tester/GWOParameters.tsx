...
const GWOParameters: React.FC = () => {
    ...
    return (
        <div className="space-y-4">
            <SectionContainer header="GWO Parameters">
                ...
                >
                    {loading ? "Running GWO..." : "Run GWO"}
                </button>
            </SectionContainer>

            {/* Wyniki */}
            {result.Message && (
                <SectionContainer header="GWO Info">
                    <div>{result.Message}</div>
                </SectionContainer>
            )}
            {result.BestSolution && (
                <SectionContainer header="GWO Result">
...
// --- Komponenty pomocnicze (Input/Select) ---
// Możesz je wydzielić do oddzielnych plików, jeśli chcesz ich używać w AquilaParameters też.
